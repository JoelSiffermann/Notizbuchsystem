...
public void onLoad() {
   ...
   * <code>.test-headline</code> referenzieren bzw. formatieren.
   * 
  ...
  protected HTML createHeadline(String text) {
    ...
    content.setStylePrimaryName("test-headline");
    return content;
  }
   ...
   * <code>.test-simpletext</code> referenzieren bzw. formatieren.
   * 
  ...
  protected void append(String text) {
    HTML content = new HTML(text);
    content.setStylePrimaryName("test-simpletext");
    this.add(content);
  }
