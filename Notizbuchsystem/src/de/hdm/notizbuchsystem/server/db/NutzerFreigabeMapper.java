...
private static NutzerFreigabeMapper nutzerFreigabeMapper = null;
	...
	public NutzerFreigabe erstellen(NutzerFreigabe nf) {
		...
		try{
			...
			if (rs.next()) {
				...
				stmt.executeUpdate("INSERT INTO NutzerFreigabe (NutzerFreigabe-ID, Freigabe-ID, Nutzer-ID) " + "VALUES (" + nf.getID()
						+ "," + nf.getNutzerID() + "," + 
						nf.getFreigabeID() + " )");
			}
		}
	...
	public NutzerFreigabe bearbeiten(NutzerFreigabe nf) {
		Connection con = DBConnection.getConnection();
	...
	public void loeschen(NutzerFreigabe nf) {
		Connection con = DBConnection.getConnection();
